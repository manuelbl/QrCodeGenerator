...
public class DataSegmentNumericTest : DataSegmentTestBase
{
    ...
    public void NumericEncoding()
    {
        ...
        {
            Assert.Equal(b is >= '0' and <= '9', DataSegmentNumeric.IsNumeric((byte)b));
        }
    }
    ...
    {
        EncodeAndCompare(text, expectedData, data => new DataSegmentNumeric(data));
    }
    ...
    {
        EncodeDecode(text, t => new DataSegmentNumeric(t), DecodeNumeric);
    }
