...
namespace Net.Codecrete.QrCodeGenerator.Test
{
    public class DataSegmentByteTest : DataSegmentTestBase
    {
        ...
        {
            EncodeAndCompare(text, expectedData, data => new DataSegmentByte(new ArraySegment<byte>(data)));
        }
        ...
        {
            EncodeDecode(text, t => new DataSegmentByte(new ArraySegment<byte>(t)), DecodeByte);
        }
