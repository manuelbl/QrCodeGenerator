...
public class DataSegmentTest : DataSegmentTestBase
{
    ...
    public void GetByteLength(DataSegmentMode mode, string text)
    {
        ...
        var segment = DataSegment.MakeSegment(mode, data);
    ...
    public void GetByteLengthKanji()
    {
        ...
        var segment = new DataSegmentKanji(data);
    ...
    public void EncodeFromText(string text)
    {
        ...
        foreach (var segment in segments)
        {
            ...
            {
                Assert.True(segment.Mode != previousSegment.Mode);
            }
    ...
    public void EncodeWithoutEci()
    {
        ...
        Assert.Equal(text, Encoding.UTF8.GetString(segment.DataBytes));
    ...
    public static TheoryData<List<DataSegment>, int, int> DataSegmentsTheoryData {
        get
        {
            ...
            [
                new DataSegmentByte("abc"u8.ToArray())
            ]);
            ...
            segments = new List<DataSegment>(
            [
                new DataSegmentNumeric("137"u8.ToArray())
            ]);
            ...
            segments = new List<DataSegment>(
            [
                new DataSegmentAlphanumeric("CDEF"u8.ToArray())
            ]);
            ...
            [
                ...
                new DataSegmentKanji(ECI.ShiftJIS.GetEncoding().GetBytes("け希"))
            ]);
    ...
    public void GetBitLength()
    {
        ...
        [
            new DataSegmentEci(ECI.UTF8),
            new DataSegmentAlphanumeric("ABC012"u8.ToArray())
        ]);
    ...
    public void GetText()
    {
        ...
        var segments = new List<DataSegment>();
        segments.Add(new DataSegmentStructuredAppend(1, 3, 0xd2));
        segments.Add(new DataSegmentEci(ECI.Windows1252));
    ...
    {
        Assert.Equal("[Mode: Numeric; Data length: 1]", new DataSegmentNumeric(new byte[1]).ToString());
        Assert.Equal("[Mode: Alphanumeric; Data length: 2]", new DataSegmentAlphanumeric(new byte[2]).ToString());
        Assert.Equal("[Mode: Kanji; Data length: 4]", new DataSegmentKanji(new byte[4]).ToString());
        Assert.Equal("[Mode: Binary; Data length: 5]", new DataSegmentByte(new byte[5]).ToString());
