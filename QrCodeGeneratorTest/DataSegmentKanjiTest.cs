...
namespace Net.Codecrete.QrCodeGenerator.Test
{
    public class DataSegmentKanjiTest : DataSegmentTestBase
    {
        ...
        {
            EncodeAndCompare(text, expectedData, data => new DataSegmentKanji(new ArraySegment<byte>(data)), ECI.ShiftJIS.GetEncoding());
        }
        ...
        {
            EncodeDecode(text, t => new DataSegmentKanji(new ArraySegment<byte>(t)), DecodeKanji, ECI.ShiftJIS.GetEncoding());
        }
