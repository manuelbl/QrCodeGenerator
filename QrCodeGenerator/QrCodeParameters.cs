...
{
    /// <summary>
    /// The ISO/IEC 18004 parameter tables, keyed by version (1–40) and error
    /// correction level (0–3 = L/M/Q/H).
    /// <para>
    /// This is the foundation depended on by the rest of the pipeline
    /// (<see cref="VersionPlanner"/>, <see cref="Codewords"/>,
    /// <see cref="MatrixEncoder"/>) as well as <see cref="FixedPatterns"/> and
    /// <see cref="StructuredAppend"/>. The comments cite the table numbers in the
    /// specification.
    /// </para>
    /// </summary>
    internal static class QrCodeParameters
    {
        #region Size
